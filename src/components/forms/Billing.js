				...
				<article className="message is-dark is-small">
					<div className="message-body">
						<div className="content">
							...
							<ul>
								<li>
									<strong>Account balance.</strong> Your account has a cash balance, which is used to
									pay rewards to your promoters. The balance and transactions are available on the
									dashboard in real-time.
								</li>
								<li>
									<strong>Spending Limits.</strong> Your campaign is running as long as your balance
									is positive, but it pauses automatically once your spending limit is reached. You
									can change this limit at any time.
								</li>

								<li>
									<strong>Automatic charges.</strong> You give us your permission to automatically top
									up your account balance from your card when required, according to your spending
									limits.
								</li>
								<li>
									<strong>Risk free.</strong> The unused balance on your account can be refunded at
									your request at any time, no questions asked.
								</li>
							</ul>
						</div>
					</div>
