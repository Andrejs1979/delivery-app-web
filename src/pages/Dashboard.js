                  ...
                  <div className="level-left">
                    <span>
                      ...
                      <p className="subtitle">
                        Upload your void check to activate your payments
                      </p>
                    </span>
                  </div>
          ...
          <div className="tile">
            <div className="tile is-parent is-vertical">
              <article className="tile is-child notification is-primary">
                <p className="title">Orders {postCount}</p>
              ...
              <article className="tile is-child notification is-dark">
                <p className="title">Sales ${spent}</p>
                {/* <p className="subtitle">Locations covered by your promo</p> */}
              </article>
            </div>
            <div className="tile is-parent">
              {posts.length > 1 ? (
                ...
                <article className="tile is-child notification is-light">
                  <p className="title">Top menu item</p>
                  <p className="subtitle">Picture of menu item</p>
                  {/* <Cards type="posts" data={[ posts[0] ]} /> */}
            ...
            <div className="tile is-parent">
              <article className="tile is-child notification is-light">
                <div className="content">
                  ...
                  <p className="subtitle">Latest orders</p>
                  <div className="content">
    ...
    <div className="columns is-multiline is-mobile">
      {data.posts.map(item => (
        <figure className="image is-100x100" key={item.id}>
          <img
            src={`${CLOUDINARY}/c_scale,w_100/posts/${item.uri}`}
            alt="Post"
          />
        </figure>
      ))}
